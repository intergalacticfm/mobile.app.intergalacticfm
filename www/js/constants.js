...
const IS_DISABLED_CSS_CLASS = 'is-disabled';
const CLICK_EVENT_NAME = 'click';
const MEDIASESSION_NAME = 'mediaSession';
const TRACK_INFO_MODAL_ID = 'trackInfoModal';
const CONTAINER_ID = 'container';
const CLOSE = 'close';
const NONE = 'none';
const BLOCK = 'block';
const SYSTEM_READY_MSG = 'System ready.<br> Select a channel to play.';
const DEVICE_READY_EVENT_NAME = 'deviceready';
